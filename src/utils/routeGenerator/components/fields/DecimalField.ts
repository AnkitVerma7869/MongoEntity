/**
 * Decimal Number Field Generator
 * Generates HTML/JSX for decimal number input form fields
 */

import { Attribute } from '../../../../interfaces/types';

/**
 * Generates a decimal number input field component
 * @param {Attribute} attr - Field attribute configuration
 * @param {string} fieldName - Name of the form field
 * @param {string} defaultValue - Default decimal value
 * @returns {string} Generated decimal number field JSX
 */
export function generateDecimalField(attr: Attribute, fieldName: string, defaultValue: string) {
